...
export const getVendorCalendar = (params) => api.get('/vendors/calendar', { params })
export const blockCalendarDate = (date) => api.post('/vendors/calendar/block', { date })
export const unblockCalendarDate = (dateId) => api.delete(`/vendors/calendar/${encodeURIComponent(dateId)}`)
export const getMyReviews = (params) => api.get('/vendors/my-reviews', { params })
